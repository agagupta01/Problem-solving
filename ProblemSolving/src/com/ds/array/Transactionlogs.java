...
public class Transactionlogs {
    ...
    public static void main(String[] args) {
        ...
        input.add ("345366 89921 45");
        input.add ("029323 38239 23");
        input.add("38239 345366 15");
        input.add  ("029323 38239 77");
        input.  add ("345366 38239 23");
        input.   add ("029323 345366 13");
        input.   add ("38239 38239 23");
